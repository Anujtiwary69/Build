...
$filename = "tmp/website".rand().date('His').".zip"; //use the /tmp folder to circumvent any permission issues on the root folder
/* END CONFIG */
// $tmpfilename = 'tmp/website12.zip';
